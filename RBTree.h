...
# define __cpp_lib_generic_associative_lookup 201304L
  ...
  struct _Rb_tree_node_base
  {
    ...
    static base_ptr
    _minimum(base_ptr x) _GLIBCXX_NOEXCEPT
    {
    ...
    _minimum(const_base_ptr x) _GLIBCXX_NOEXCEPT
    {
      while (x->left != 0) x = x->left;
      return x;
    }
    ...
    static base_ptr
    _maximum(base_ptr x) _GLIBCXX_NOEXCEPT
    {
    ...
    static const_base_ptr
    _maximum(const_base_ptr x) _GLIBCXX_NOEXCEPT
    {
      while (x->right != 0) x = x->right;
      return x;
    }
  ...
  struct _Rb_tree_header
  {
    ...
    {
      if (__x._M_header.parent != nullptr)
	_M_move_data(__x);
      else
	{
	  _M_header.color = _S_red;
  ...
  template<typename _Tp>
    struct _Rb_tree_iterator
    {
      ...
      explicit
      _Rb_tree_iterator(base_ptr __x) _GLIBCXX_NOEXCEPT
      : _M_node(__x) { }
  ...
  template<typename _Tp>
    struct _Rb_tree_const_iterator
    {
      ...
      explicit
      _Rb_tree_const_iterator(base_ptr __x) _GLIBCXX_NOEXCEPT
      : _M_node(__x) { }
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
    ...
    protected:
      ...
      base_ptr&
      leftmost() _GLIBCXX_NOEXCEPT
      { return this->_M_impl._M_header.left; }

      const_base_ptr
      leftmost() const _GLIBCXX_NOEXCEPT
      { return this->_M_impl._M_header.left; }

      base_ptr&
      rightmost() _GLIBCXX_NOEXCEPT
      { return this->_M_impl._M_header.right; }

      const_base_ptr
      rightmost() const _GLIBCXX_NOEXCEPT
      { return this->_M_impl._M_header.right; }

      _Link_type
      _M_mbegin() const _GLIBCXX_NOEXCEPT
      { return static_cast<_Link_type>(this->_M_impl._M_header.parent); }
...
# endif // C++17
	...
	return _KeyOfValue()(*__x->_M_valptr());
      ...
      static _Link_type
      _S_left(base_ptr __x) _GLIBCXX_NOEXCEPT
      { return static_cast<_Link_type>(__x->left); }

      static _Const_Link_type
      _S_left(const_base_ptr __x) _GLIBCXX_NOEXCEPT
      { return static_cast<_Const_Link_type>(__x->left); }

      static _Link_type
      _S_right(base_ptr __x) _GLIBCXX_NOEXCEPT
      { return static_cast<_Link_type>(__x->right); }

      static _Const_Link_type
      _S_right(const_base_ptr __x) _GLIBCXX_NOEXCEPT
      { return static_cast<_Const_Link_type>(__x->right); }
      ...
      static base_ptr
      _minimum(base_ptr __x) _GLIBCXX_NOEXCEPT
      { return _Rb_tree_node_base::_minimum(__x); }

      static const_base_ptr
      _minimum(const_base_ptr __x) _GLIBCXX_NOEXCEPT
      { return _Rb_tree_node_base::_minimum(__x); }

      static base_ptr
      _maximum(base_ptr __x) _GLIBCXX_NOEXCEPT
      { return _Rb_tree_node_base::_maximum(__x); }

      static const_base_ptr
      _maximum(const_base_ptr __x) _GLIBCXX_NOEXCEPT
      { return _Rb_tree_node_base::_maximum(__x); }
	...
	iterator
	_M_insert_(base_ptr __x, base_ptr __y, _Arg&& __v, _NodeGen&);

      iterator
      _M_insert_node(base_ptr __x, base_ptr __y, _Link_type __z);

      template<typename _Arg>
	iterator
	_M_insert_lower(base_ptr __y, _Arg&& __v);
	...
	_M_insert_equal_lower(_Arg&& __x);
      ...
      iterator
      _M_insert_lower_node(base_ptr __p, _Link_type __z);
	...
	_Link_type
	_M_copy(_Link_type, base_ptr, _NodeGen&);
	...
	_M_copy(const _Rb_tree& __x, _NodeGen& __gen)
	{
	  ...
	  leftmost() = _minimum(__root);
	  rightmost() = _maximum(__root);
	...
	return _M_copy<__as_lvalue>(__x, __an);
      ...
      iterator
      _M_lower_bound(_Link_type __x, base_ptr __y,
		     const _Key& __k);

      const_iterator
      _M_lower_bound(_Const_Link_type __x, const_base_ptr __y,
		     const _Key& __k) const;

      iterator
      _M_upper_bound(_Link_type __x, base_ptr __y,
		     const _Key& __k);

      const_iterator
      _M_upper_bound(_Const_Link_type __x, const_base_ptr __y,
		     const _Key& __k) const;
	...
	iterator
	_M_insert(pair<base_ptr, base_ptr> __p)
	{
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
    ...
    _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::
#if __cplusplus >= 201103L
    _M_insert_lower(base_ptr __p, _Arg&& __v)
#else
    _M_insert_lower(base_ptr __p, const _Val& __v)
#endif
    {
  ...
  template<typename _Key, typename _Val, typename _KoV,
    ...
    template<bool _MoveValues, typename _NodeGen>
      ...
      _M_copy(_Link_type __x, base_ptr __p, _NodeGen& __node_gen)
      {
	...
	__try
	  {
		...
		__y->parent = __p;
		if (__x->right)
		  __y->right = _M_copy<_MoveValues>(_S_right(__x),
						       __y, __node_gen);
		__p = __y;
		__x = _S_left(__x);
	      }
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
	...
	{
	  if (size() > 0
	      && _M_impl._M_key_compare(_S_key(rightmost()), __k))
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
	...
	{
	  if (size() > 0
	      && !_M_impl._M_key_compare(__k, _S_key(rightmost())))
	    return _Res(0, rightmost());
	  else
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
    ...
    auto
    _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::
    _M_insert_node(base_ptr __x, base_ptr __p, _Link_type __z)
    -> iterator
    {
      bool __insert_left = (__x != 0 || __p == _M_end()
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
	...
	static_cast<_Link_type>(_Rb_tree_rebalance_for_erase
				(const_cast<base_ptr>(__position._M_node),
				 this->_M_impl._M_header));
      _M_drop_node(__y);
      --_M_impl._M_node_count;
    }
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
	...
	return _M_impl._M_node_count == 0 && begin() == end()
	       && this->_M_impl._M_header.left == _M_end()
	       && this->_M_impl._M_header.right == _M_end();
      ...
      for (const_iterator __it = begin(); __it != end(); ++__it)
	{
	  ...
	  if (__x->color == _S_red)
	    if ((__L && __L->color == _S_red)
		|| (__R && __R->color == _S_red))
	      return false;
      ...
      if (leftmost() != _Rb_tree_node_base::_minimum(_M_root()))
	return false;
      if (rightmost() != _Rb_tree_node_base::_maximum(_M_root()))
	return false;
      return true;
    }
